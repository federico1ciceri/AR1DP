...
2. **Validation analysis**: <br />
   ...
   - _External_: the employed indexes show a similarity in the partitions generated by AR1DP and other nonparametric approaches. Here the comparison with PAM:
